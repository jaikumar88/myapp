	...
	<form:form method="POST" modelAttribute="transaction" class="form-horizontal" >
		...
		<div class="row">
				...
				<sec:authorize access="hasRole('USER') or hasRole('ADMIN')">
							<td><a href="<c:url value='/close-now-${transaction.id}' />" class="btn btn-success custom-width">Close Now</a></td>
				        </sec:authorize>
				        <sec:authorize access="hasRole('USER') or hasRole('ADMIN')">
							<td><a href="<c:url value='/newActivity' />" class="btn btn-success custom-width">Pay latter</a></td>
				        </sec:authorize>
